...
public class CheckBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox5.setText("Sport");

        jLabel1.setText("Wybierz zainteresowania");

        jCheckBox6.setText("Gry komputerowe");

        jCheckBox7.setText("Wędkarstwo");

        jCheckBox8.setText("Muzyka");
